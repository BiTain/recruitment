...
(
    ...
    trangThai ENUM ('KHONG_HOAT_DONG','HOAT_DONG','BI_KHOA'),
...
(
    ...
    trangThai ENUM('HET_HAN','CON_HAN','KHOA_BOI_DN','KHOA_BOI_ADMIN'),
    taoVaoLuc DATETIME DEFAULT CURRENT_TIMESTAMP,
    capNhatVaoLuc DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(
    ...
    ketQua ENUM('TU_CHOI','THONG_QUA','DANG_CHO','CHO_PHONG_VAN'),
    taoVaoLuc DATETIME DEFAULT CURRENT_TIMESTAMP,
    capNhatVaoLuc DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(
    ...
    trangThai ENUM('TU_CHOI','DONG_Y','DANG_CHO','HOAN_THANH'),
    soYeuLyLich VARCHAR(255),
    hanXacNhan DATETIME,
    taoVaoLuc DATETIME DEFAULT CURRENT_TIMESTAMP,
    capNhatVaoLuc DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
